...
declare namespace XEUtils {
  ...
  */
   ...
   * @param context 上下文
   */
  export function arrayEach<T, C>(list: T[], iterate: (this: C, item: T, index: number, list: T[]) => void, context?: C): void;
  export function arrayEach<T, C>(obj: T, iterate: (this: C, item: any, index: number, obj: T) => void, context?: C): void;
   ...
   */
  export function findTree<T, C>(list: T[], iterate: (this: C, item: T, index: number, items: T[], path: string[], parent: T, nodes: T[]) => boolean, options?: FindTreeOptions, context?: C): TerrResult;
   ...
   * @param context 上下文
   */
  export function findLastIndexOf<T, C>(list: T, iterate: (this: C, item: T, index: number, list: T[]) => boolean, context?: C): T;
   ...
   * @param context 上下文
   */
  export function findLastIndexOf<C>(obj: any, iterate: (this: C, item: any, key: string, obj: any) => boolean, context?: C): any;
   ...
   * @param context 上下文
   */
  export function each<T, C>(list: T[], iterate: (this: C, item: T, index: number, list: T[]) => void, context?: CSSKeyframeRule): void;
   ...
   * @param obj 值
   */
  export function toString(obj: number | string | any[]): string;
